...
public class Environment extends SimStateSweep {
    ...
    public double fMax = 50;
    public int distance_space_dates;
	...
	public int getDistance_space_dates() {
		return distance_space_dates;
	}
	
	public void setDistance_space_dates(int distance_space_dates) {
		this.distance_space_dates = distance_space_dates;
	}
	/**
	...
	public void makeAgentsSpatial() {
		for(int i=0;i<females;i++) {
			...
			Agent f = new Agent(x, y,xdir,ydir, true,attractiveness);
		...
		for(int i=0;i<males;i++) {
			...
			int ydir = random.nextInt(3)-1;
			double attractiveness = random.nextInt((int)maxAttractiveness)+1;
			Agent m = new Agent(x, y,xdir,ydir, false,attractiveness);
