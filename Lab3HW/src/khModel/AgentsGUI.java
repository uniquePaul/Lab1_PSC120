...
public class AgentsGUI extends GUIStateSweep {
	...
	public static void main(String[] args) {
		...
		String[] title = { "Couple Correlation", "Mean Attractiveness" };// A string array, where every entry is the
																			// title of a chart
		...
		// AgentsGUI.initializeArrayTimeSeriesChart(number of charts, chart titles,
		// x-axis titles, y-axis titles);
		AgentsGUI.initializeArrayTimeSeriesChart(2, title, x, y);// creates as many charts as indicated by the first
																	// number.
		...
		AgentsGUI.initialize(Environment.class, Experimenter.class, AgentsGUI.class, 400, 400, Color.WHITE, Color.BLUE,
				false, Spaces.SPARSE);
	}
}
